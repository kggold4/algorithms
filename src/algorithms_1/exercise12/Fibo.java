package algorithms_1.algo_1_exercise12;
...
public class Fibo {
	...
	public static int fibRecursion(int n) {
		return fibRecursion(F,n)[1][1];
	}
	public static int[][] fibRecursion(int[][] A,int n) {
		if(n == 0) return F;
		if(n % 2 == 1) return mulMat(fibRecursion(mulMat(A,A),(n-1)/2),A);
		return fibRecursion(mulMat(A,A),n/2);
	}
